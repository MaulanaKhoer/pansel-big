...
export default function GazetteerDelete() {
    ...
    const url_update = Config.api_domain + "/formasi/update/";
    const url_get = Config.api_domain + "/formasi/active/";
    ...
    return <Container>
        <Wrapper>
            <Form>
                ...
                <TextField size="small" fullWidth label="Formasi Content" color="secondary"
