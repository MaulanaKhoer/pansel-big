...
export default function Edit() {
    ...
    function validateForm() {
        return !loading && name.length > 0 && email.length > 0;
    }
        ...
        <Wrapper>
            <Form>
                <form onSubmit={(e) => handleSubmit(e)}>
                    <Input>
                        <TextField size="small" fullWidth label="Fullname" color="secondary" value={name} onChange={(e) => setName(e.target.value)} />
                    </Input>
                    <Input>
                        <TextField size="small" fullWidth label="Email" color="secondary" value={email} onChange={(e) => setEmail(e.target.value)} />
                    </Input>
