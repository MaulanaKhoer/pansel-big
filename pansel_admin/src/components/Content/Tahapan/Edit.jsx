...
export default function GazetteerDelete() {
    ...
    const url_update = Config.api_domain + "/tahapan/update/";
    const url_get = Config.api_domain + "/tahapan/active/";
    ...
    return <Container>
        <Wrapper>
            <Form>
                ...
                <TextField size="small" fullWidth label="Tahapan Content" color="secondary"
