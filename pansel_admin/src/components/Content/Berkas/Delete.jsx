...
export default function DataDelete({ dataId, setOpenDialog, setRefresh }) {
    ...
    const url_delete = Config.api_domain + "/unduh_berkas/" + dataId;
    ...
    const postData = async () => {
        try {
            ...
            if (response.status === 200 || json.status === 'success') {
                ...
                setOpen(true);
                setMessage("Berkas deleted successfully!");
                ...
                setOpenBackdrop(false);
                setOpen(true);
                setMessage(json.message || "Failed to delete berkas");
            }
        } catch (error) {
            setSuccess(false);
            setLoading(false);
        ...
        <div style={{ padding: '20px' }}>
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div style={{ 
                    ...
                    ⚠️ Apakah Anda yakin ingin menghapus berkas unduh ini? Tindakan ini tidak dapat dibatalkan.
                </div>
