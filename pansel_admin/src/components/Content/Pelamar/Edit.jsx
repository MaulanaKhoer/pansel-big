...
export default function GazetteerDelete() {
    ...
    const url_update = Config.api_domain + "/pengumuman/update/";
        ...
        <Wrapper>
            <Form>
                <form onSubmit={(e) => handleSubmit(e)}>
                    <Input>
                        <TextField size="small" fullWidth label="Judul" color="secondary" value={name} onChange={(e) => setName(e.target.value)} />
                    </Input>
                    {
                    /*
                    <Input>
                        <TextField size="small" fullWidth label="Label" color="secondary" value={featureType} onChange={(e) => setFeatureType(e.target.value)} />
                    </Input>
                    */
                    }
                    <Bottom >
