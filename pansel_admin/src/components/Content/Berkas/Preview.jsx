...
export default function DataPreview() {
    ...
    const url_view = Config.api_domain + "/berkas/view/" + dataId;
        ...
        <Wrapper>
            <Form>
                <Top>
                    <Left>
                        <Input>
                            <TextField size="small" fullWidth label="Berkas Title" color="secondary" value={name} onChange={(e) => setName(e.target.value)} disabled />
                        </Input>
                        <Input>
