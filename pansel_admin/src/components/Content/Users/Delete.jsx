...
export default function DataDelete({ dataId, setOpenDialog, setRefresh }) {
    ...
    const url_get = "../api/user/id/" + dataId;
    const url_delete = "../api/user/delete/";
            ...
            <Form>
                <form onSubmit={(e) => handleSubmit(e)}>
                    <Top>
                        <Left>
                        <Input>
                                <TextField fullWidth id="name" label="Fullname" color="secondary" size="small" value={name}  disabled />
                            </Input>
                            <Input>
                                <TextField fullWidth id="email" label="Email" type="email" color="secondary" size="small" value={email}  disabled />
                            </Input>
                            <Input>
                                <TextField fullWidth id="username" label="Username" color="secondary" size="small" value={username}  disabled />
                            </Input>
                        </Left>
                    </Top>
                    <span>
