                ...
                <Paper elevation={1} style={{ padding: "0 0 1em 0", marginBottom: "1em" }}>
                    ...
                    <div style={{ padding: "15px" }}>
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_1 ?
                                    <Button variant="contained" component="a" href={url_download +  lamaran?.user_public_id + "/" + lamaran?.file_1} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_2 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_2} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_3 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_3} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_4 ?
                                    ...
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_4} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_5 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_5} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_6 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_6} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_7 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_7} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_8 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_8} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_9 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_9} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_10 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_10} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_11 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_11} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_12 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_12} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_13 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_13} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_14 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_14} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_15 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_15} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_16 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_16} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_17 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_17} >
                                        Lihat
                                    </Button>
                                    : null
                                }
                        ...
                        <Input>
                            ...
                            <ButtonWrapper>
                                {lamaran?.file_18 ?
                                    <Button variant="contained" component="a" href={url_download + lamaran?.user_public_id  + "/" + lamaran?.file_18} >
                                        Lihat
                                    </Button>
                                    : null
                                }
