...
export default function DataDelete({ dataId, setOpenDialog, setRefresh }) {
    ...
    const url_get = "../api/metadata/id/" + dataId;
    const url_update = "../api/metadata/updateAdmin/";

    const url_pull = "../api/harvestings/pull/1";
    ...
    useEffect(() => {
        ...
        try {
            ...
            fetch(url_get, requestOptions).then(res => res.json()).then(data => {
                setStatus(data.status? 'Approved by walidata': 'Waiting for approval');
    ...
    const fetchCSW = async () => {
        ...
        try {
            ...
            const response = await fetch(url_pull, requestOptions)
        ...
        <Wrapper>
            <Form>
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <span>
                        Are you sure you want to publish this metadata?
                    </span>
