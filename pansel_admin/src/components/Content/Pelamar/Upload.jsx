...
export default function Upload({ setOpenDialog, dataId, setRefresh }) {
    ...
    const url_upload = Config.api_domain + "/pengumuman_file/";
    ...
    const postData = async () => {
        ...
        try {
            ...
            formData.append("pengumuman_public_id", dataId);
            /*
